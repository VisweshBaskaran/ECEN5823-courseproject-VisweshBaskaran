...
//0x92, 0xE4, 0x0C, 0xEA, 0x35, 0x90
//#define SERVER_BT_ADDRESS (bd_addr){.addr = { 0x92, 0xE4, 0x0C, 0xEA, 0x35, 0x90 }}

#define SERVER_BT_ADDRESS (bd_addr){.addr = { 0x1c, 0x03, 0x92, 0x27, 0x0fd, 0x84 }}
//#define SERVER_BT_ADDRESS (bd_addr){.addr = { 0x44, 0x0e, 0x64, 0x27, 0x71, 0x84 }}

//#define CLIENT_BT_ADDRESS (bd_addr){.addr = { 0x1c, 0x03, 0x92, 0x27, 0x0fd, 0x84 }}
