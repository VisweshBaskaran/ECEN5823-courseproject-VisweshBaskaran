...
/*
  Defining conditions to sleep according to the Energy Modes
  Sleep only in EM1, EM2, EM3 energy modes and not in EM0
 */
...
SL_WEAK void app_init(void)
{
  ...
  //perform initialization steps for gpio, oscillators and LETIMER0
...
// Add Power Management requirement only EM2 for bluetooth functionality
#ifdef LOWEST_ENERGY_MODE
...
//  //get the next event
//  evt = getNextEvent();
//  //pass the event obtained to the state machine
